...
namespace MobyShop.WebAPI.Migrations
{
    ...
    [Migration("20210915210723_password_fix")]
    partial class password_fix
    {
            ...
            modelBuilder.Entity("MobyShop.WebAPI.Database.Klijenti", b =>
                {
                    ...
                    b.HasData(
                        new { KlijentId = 1, DatumRegistracije = new DateTime(2021, 9, 15, 23, 7, 21, 456, DateTimeKind.Local), Email = "admin@mail.com", Ime = "Admin", KorisnickoIme = "admin", LozinkaHash = "NEENrmkBAdWxNI0fN3Ihf5cVBmw=", LozinkaSalt = "aVY2L2hs+jsexU4eKgotaQ==", Prezime = "Admin", Telefon = "063232213" },
                        new { KlijentId = 2, DatumRegistracije = new DateTime(2021, 9, 15, 23, 7, 21, 482, DateTimeKind.Local), Email = "user@mail.com", Ime = "User", KorisnickoIme = "user", LozinkaHash = "Lo3bPPeIYb/2iXhQDryCIz/wFsc=", LozinkaSalt = "I2/2DjnXR/31hADUXPFa6w==", Prezime = "User", Telefon = "063132233" },
                        new { KlijentId = 3, DatumRegistracije = new DateTime(2021, 9, 15, 23, 7, 21, 483, DateTimeKind.Local), Email = "amna@mail.com", Ime = "Amna", KorisnickoIme = "amna123", LozinkaHash = "mSSYXRweOYdYlt/cI8O2AyUGjh0=", LozinkaSalt = "e+6fwCPEo7UxydTbMyn/cA==", Prezime = "Dj", Telefon = "063232245" }
                    );
                });
            ...
            modelBuilder.Entity("MobyShop.WebAPI.Database.Korisnici", b =>
                {
                    ...
                    b.HasData(
                        new { KorisnikId = 1, Email = "admin@mail.com", Ime = "Admin", KorisnickoIme = "admin", LozinkaHash = "NEENrmkBAdWxNI0fN3Ihf5cVBmw=", LozinkaSalt = "aVY2L2hs+jsexU4eKgotaQ==", Prezime = "Admin", Telefon = "063232983" },
                        new { KorisnikId = 2, Email = "prodavac@mail.com", Ime = "Prodavac", KorisnickoIme = "prodavac", LozinkaHash = "Lo3bPPeIYb/2iXhQDryCIz/wFsc=", LozinkaSalt = "I2/2DjnXR/31hADUXPFa6w==", Prezime = "Prodavac", Telefon = "063235785" },
                        new { KorisnikId = 3, Email = "user@mail.com", Ime = "User", KorisnickoIme = "user", LozinkaHash = "mReZlP1LxIT5qWvS0jQrJ4AGXZ8=", LozinkaSalt = "e+6fwCPEo7UxydTbMyn/cA==", Prezime = "User", Telefon = "063132233" },
                        new { KorisnikId = 4, Email = "amna@mail.com", Ime = "Amna", KorisnickoIme = "amna136", LozinkaHash = "qRzF2g+BfRN6vdwbjnGRmGWiBiw=", LozinkaSalt = "RMtMFHm4qiz1085fjYxadA==", Prezime = "Dj", Telefon = "063132233" }
                    );
                });
            ...
            modelBuilder.Entity("MobyShop.WebAPI.Database.KorisniciUloge", b =>
                {
                    ...
                    b.HasData(
                        new { KorisnikUlogaId = 1, DatumIzmjene = new DateTime(2021, 9, 15, 23, 7, 21, 484, DateTimeKind.Local), KorisnikId = 1, UlogaId = 1 },
                        new { KorisnikUlogaId = 2, DatumIzmjene = new DateTime(2021, 9, 15, 23, 7, 21, 484, DateTimeKind.Local), KorisnikId = 2, UlogaId = 2 },
                        new { KorisnikUlogaId = 3, DatumIzmjene = new DateTime(2021, 9, 15, 23, 7, 21, 484, DateTimeKind.Local), KorisnikId = 3, UlogaId = 2 }
                    );
                });
            ...
            modelBuilder.Entity("MobyShop.WebAPI.Database.Nabavka", b =>
                {
                    ...
                    b.HasData(
                        new { NabavkaId = 1, BrojNabavke = "1", Datum = new DateTime(2021, 9, 15, 23, 7, 21, 485, DateTimeKind.Local), DobavljacId = 1, IznosRacuna = 1500m, KorisnikId = 1, Napomena = "Prva nabavka", Pdv = 17m, SkladisteId = 1 },
                        new { NabavkaId = 2, BrojNabavke = "2", Datum = new DateTime(2021, 9, 15, 23, 7, 21, 486, DateTimeKind.Local), DobavljacId = 2, IznosRacuna = 1000m, KorisnikId = 1, Napomena = "Druga nabavka", Pdv = 17m, SkladisteId = 1 },
                        new { NabavkaId = 3, BrojNabavke = "3", Datum = new DateTime(2021, 9, 15, 23, 7, 21, 486, DateTimeKind.Local), DobavljacId = 2, IznosRacuna = 1404m, KorisnikId = 2, Napomena = "Treca nabavka", Pdv = 17m, SkladisteId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("MobyShop.WebAPI.Database.Narudzba", b =>
                {
                    ...
                    b.HasData(
                        new { NarudzbaId = 1, BrojNarudzbe = "1", Datum = new DateTime(2021, 9, 15, 23, 7, 21, 486, DateTimeKind.Local), IznosBezPdv = 1000m, IznosSaPdv = 1170m, KlijentId = 1, KorisnikId = 1, Otkazano = false, SkladisteId = 1, Status = true },
                        new { NarudzbaId = 2, BrojNarudzbe = "2", Datum = new DateTime(2021, 9, 15, 23, 7, 21, 487, DateTimeKind.Local), IznosBezPdv = 900m, IznosSaPdv = 1053m, KlijentId = 1, KorisnikId = 3, Otkazano = false, SkladisteId = 2, Status = true }
                    );
                });
            ...
            modelBuilder.Entity("MobyShop.WebAPI.Database.Ocjene", b =>
                {
                    ...
                    b.HasData(
                        new { OcjenaId = 1, ArtikalId = 2, Datum = new DateTime(2021, 9, 15, 23, 7, 21, 487, DateTimeKind.Local), KlijentId = 1, Ocjena = 5 },
                        new { OcjenaId = 2, ArtikalId = 1, Datum = new DateTime(2021, 9, 15, 23, 7, 21, 488, DateTimeKind.Local), KlijentId = 1, Ocjena = 5 }
                    );
                });
