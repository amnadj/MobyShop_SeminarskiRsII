...
namespace MobyShop.WebAPI.Migrations
{
    ...
    [Migration("20210915215605_narudzbepracenjeinfo")]
    partial class narudzbepracenjeinfo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MobyShop.WebAPI.Database.Klijenti", b =>
                {
                    ...
                    b.HasData(
                        new { KlijentId = 1, DatumRegistracije = new DateTime(2021, 9, 15, 23, 56, 2, 978, DateTimeKind.Local), Email = "admin@mail.com", Ime = "Admin", KorisnickoIme = "admin", LozinkaHash = "l/pb2F6ygLsYO9hDJafWfqwFVBo=", LozinkaSalt = "ii1s5xHwIFUYGJi6/TOmUg==", Prezime = "Admin", Telefon = "063232213" },
                        new { KlijentId = 2, DatumRegistracije = new DateTime(2021, 9, 15, 23, 56, 3, 5, DateTimeKind.Local), Email = "user@mail.com", Ime = "User", KorisnickoIme = "user", LozinkaHash = "rq4VTFIDoFHcVXN0piYk2Lcg1D8=", LozinkaSalt = "XadGYyQ+seLfAyFkXdXoCA==", Prezime = "User", Telefon = "063132233" },
                        new { KlijentId = 3, DatumRegistracije = new DateTime(2021, 9, 15, 23, 56, 3, 5, DateTimeKind.Local), Email = "amna@mail.com", Ime = "Amna", KorisnickoIme = "amna123", LozinkaHash = "01D00KV+G5V8Sl2AZWZ7dkLkwhE=", LozinkaSalt = "0S7swSCGvtdtSjddVTZe7g==", Prezime = "Dj", Telefon = "063232245" }
                    );
                });
            ...
            modelBuilder.Entity("MobyShop.WebAPI.Database.Korisnici", b =>
                {
                    ...
                    b.HasData(
                        new { KorisnikId = 1, Email = "admin@mail.com", Ime = "Admin", KorisnickoIme = "admin", LozinkaHash = "l/pb2F6ygLsYO9hDJafWfqwFVBo=", LozinkaSalt = "ii1s5xHwIFUYGJi6/TOmUg==", Prezime = "Admin", Telefon = "063232983" },
                        new { KorisnikId = 2, Email = "prodavac@mail.com", Ime = "Prodavac", KorisnickoIme = "prodavac", LozinkaHash = "rq4VTFIDoFHcVXN0piYk2Lcg1D8=", LozinkaSalt = "XadGYyQ+seLfAyFkXdXoCA==", Prezime = "Prodavac", Telefon = "063235785" },
                        new { KorisnikId = 3, Email = "user@mail.com", Ime = "User", KorisnickoIme = "user", LozinkaHash = "aUXWEPT9TR4Gz3DShQhqraUMGc0=", LozinkaSalt = "0S7swSCGvtdtSjddVTZe7g==", Prezime = "User", Telefon = "063132233" },
                        new { KorisnikId = 4, Email = "amna@mail.com", Ime = "Amna", KorisnickoIme = "amna136", LozinkaHash = "+5tkv2Ses8JeJ1dntwMV9iNoeGM=", LozinkaSalt = "hYkzsJm7EQZAy+RgLBOEQA==", Prezime = "Dj", Telefon = "063132233" }
                    );
                });
            ...
            modelBuilder.Entity("MobyShop.WebAPI.Database.KorisniciUloge", b =>
                {
                    ...
                    b.HasData(
                        new { KorisnikUlogaId = 1, DatumIzmjene = new DateTime(2021, 9, 15, 23, 56, 3, 8, DateTimeKind.Local), KorisnikId = 1, UlogaId = 1 },
                        new { KorisnikUlogaId = 2, DatumIzmjene = new DateTime(2021, 9, 15, 23, 56, 3, 8, DateTimeKind.Local), KorisnikId = 2, UlogaId = 2 },
                        new { KorisnikUlogaId = 3, DatumIzmjene = new DateTime(2021, 9, 15, 23, 56, 3, 8, DateTimeKind.Local), KorisnikId = 3, UlogaId = 2 }
                    );
                });
            ...
            modelBuilder.Entity("MobyShop.WebAPI.Database.Nabavka", b =>
                {
                    ...
                    b.HasData(
                        new { NabavkaId = 1, BrojNabavke = "1", Datum = new DateTime(2021, 9, 15, 23, 56, 3, 9, DateTimeKind.Local), DobavljacId = 1, IznosRacuna = 1500m, KorisnikId = 1, Napomena = "Prva nabavka", Pdv = 17m, SkladisteId = 1 },
                        new { NabavkaId = 2, BrojNabavke = "2", Datum = new DateTime(2021, 9, 15, 23, 56, 3, 9, DateTimeKind.Local), DobavljacId = 2, IznosRacuna = 1000m, KorisnikId = 1, Napomena = "Druga nabavka", Pdv = 17m, SkladisteId = 1 },
                        new { NabavkaId = 3, BrojNabavke = "3", Datum = new DateTime(2021, 9, 15, 23, 56, 3, 9, DateTimeKind.Local), DobavljacId = 2, IznosRacuna = 1404m, KorisnikId = 2, Napomena = "Treca nabavka", Pdv = 17m, SkladisteId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("MobyShop.WebAPI.Database.Narudzba", b =>
                {
                    ...
                    b.HasData(
                        new { NarudzbaId = 1, BrojNarudzbe = "1", Datum = new DateTime(2021, 9, 15, 23, 56, 3, 10, DateTimeKind.Local), IznosBezPdv = 1000m, IznosSaPdv = 1170m, KlijentId = 1, KorisnikId = 1, Otkazano = false, SkladisteId = 1, Status = true },
                        new { NarudzbaId = 2, BrojNarudzbe = "2", Datum = new DateTime(2021, 9, 15, 23, 56, 3, 11, DateTimeKind.Local), IznosBezPdv = 900m, IznosSaPdv = 1053m, KlijentId = 1, KorisnikId = 3, Otkazano = false, SkladisteId = 2, Status = true }
                    );
                });
            ...
            modelBuilder.Entity("MobyShop.WebAPI.Database.NarudzbePracenjeInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("StatusPracenja");

                    b.HasKey("Id");

                    b.HasIndex("NarudzbaId");

                    b.ToTable("NarudzbePracenjeInfo");
                });
            ...
            modelBuilder.Entity("MobyShop.WebAPI.Database.Ocjene", b =>
                {
                    ...
                    b.HasData(
                        new { OcjenaId = 1, ArtikalId = 2, Datum = new DateTime(2021, 9, 15, 23, 56, 3, 12, DateTimeKind.Local), KlijentId = 1, Ocjena = 5 },
                        new { OcjenaId = 2, ArtikalId = 1, Datum = new DateTime(2021, 9, 15, 23, 56, 3, 12, DateTimeKind.Local), KlijentId = 1, Ocjena = 5 }
                    );
                });
