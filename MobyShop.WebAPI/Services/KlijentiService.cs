...
namespace MobyShop.WebAPI.Services
{
    public class KlijentiService : IKlijentiService
    {
        ...
        public Models.Klijenti Authenticiraj(string username, string pass)
        {
            ...
            if (user != null)
            {
                ...
                {
                    return _mapper.Map<Models.Klijenti>(user);
                }
            }
        ...
        {
            Database.Klijenti entity = _mapper.Map<Database.Klijenti>(request);
