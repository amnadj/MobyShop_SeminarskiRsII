...
using MobyShop.WinUI.Dobavljaci;
using MobyShop.WinUI.Izvjestaji;
using MobyShop.WinUI.Klijenti;
using MobyShop.WinUI.Korisnici;
using MobyShop.WinUI.Skladista;
using System;
...
namespace MobyShop.WinUI
{
    public partial class frmIndexAdmin : Form
    {
        ...
        private void ListaKorisnikaToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
        ...
        private void listaDobavljačaToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void noviDobavljačToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmDobavljaciDetalji frm = new frmDobavljaciDetalji();
            frm.Show();
        }

        private void listaSkladištaToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void NovoSkladišteToolStripMenuItem_Click(object sender, EventArgs e)
        {
